    ...
    dom.div({
      ...
      innerHTML: `
        ...
        <div class="container">
          ...
          <button onclick="window.state.sequencerModule.duplicateTimeline({bars:[window.state.sequencerModule.barsToDuplicate,window.state.sequencerModule.barsToDuplicateOver]})">Go</button>
        </div>
    `,
    }),
  );
