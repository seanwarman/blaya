  ...
  template: `
    ...
    <div id="toolbar">
      ...
      <div class="search-container">
        ...
        <input id="search-input" type="input" placeholder="⌘ K" @input="onSearch" v-model="search" />
        <button @click="onClear" tabindex="0" id="clear-search-button">
      ...
      <div class="open-upload-modal-button-container">
        <button class="open-upload-modal-button button-circle">
          ...
          <span class="upload-progress">
            <img src="../icons/spinner-solid.svg" />
          </span>
        </button>
      </div>
    </div>
